...
def generate_frames():
    ...
    try:
        while True:
            ...
            # Flag for LED control (based on ANY target class detection)
            ...
            for detection in detections:
                ...
                # Check if confidence is high enough and class_id is valid
                if confidence > CONFIDENCE_THRESHOLD and class_id < len(CLASSES):
                    ...
                    if x2 > x1 and y2 > y1:
                        # Add detection to the list of all valid detections
            ...
            # Control LED based on detections (still based on ALL valid detections, if they are target classes)
